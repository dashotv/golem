...
var newCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		//	logrus.Fatalf("error finding binaries: %s", err)
		//}
		//
		//if err := executeCommand("cobra", "init", name, "--pkg-name", pkg, "--config", "./."+name+".yaml"); err != nil {
		//	logrus.Fatalf("unable to 'cobra init': %s", err)
		//}
